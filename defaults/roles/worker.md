...
here. `builder` uses `opus-5-medium` by default, but naming the Luna tier here remains how
a worker gets it, and it is still not refused for either implementation role.
-->
