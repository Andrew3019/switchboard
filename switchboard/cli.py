...
def build_parser() -> argparse.ArgumentParser:
    ...
    # The three delivery modes (DESIGN-TRUTH.md:367-378). Mutually exclusive because they
    ...
    # The third parameter DESIGN-TRUTH.md:428-431 asks for, next to list and read: applying
...
def _scope(b: Broker, me: str, mine: bool) -> dict:
    ...
    `None` for the human, who is bounded by nothing (DESIGN-TRUTH:304-305, "Only agents
