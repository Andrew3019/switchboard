...
def build_parser() -> argparse.ArgumentParser:
    ...
    # The three delivery modes (DESIGN-TRUTH.md:328-339). Mutually exclusive because they
    ...
    # The third parameter DESIGN-TRUTH.md:387-390 asks for, next to list and read: applying
...
def _scope(b: Broker, me: str, mine: bool) -> dict:
    ...
    `None` for the human, who is bounded by nothing (DESIGN-TRUTH:265-266, "Only agents
