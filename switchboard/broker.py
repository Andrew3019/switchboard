...
# `sb tell`'s three delivery modes (DESIGN-TRUTH.md:399-410). They differ only in WHEN the
...
def tag(sender: str) -> str:
    ...
    tell them apart cannot weigh them (DESIGN-TRUTH.md:127-129). And *who is this from?*,
...
class Broker:
    ...
    def same_tree(self, me: str, target: str) -> bool:
        ...
        The human crosses freely into any tree — DESIGN-TRUTH:330-331, "Only agents have
    ...
    def delegate(
        ...
        *,
        ...
        prompts = [
            ...
            # Generated from the role table, never a literal list (DESIGN-TRUTH.md:133-136).
    ...
    def tell(
        ...
        no agent ever waits on another agent (DESIGN-TRUTH.md:395-397), which is why this
    ...
    def apply_preset(self, name: str, *, me: Optional[str] = None) -> int:
        ...
        DESIGN-TRUTH.md:460-463: "Picking a preset should inject a prompt: sb pastes it in,
    ...
    def done(self, summary: str, *, me: Optional[str] = None) -> list[str]:
        ...
        **Reporting done with children still working stays legal**, and the returned list
        ...
        if parent:
            ...
            #
            # WHEN IDLE, explicitly and not by default — DESIGN-TRUTH.md:381-385 names the
    ...
    def _ring(self, who: str, text: str, *, mode: str = WHEN_IDLE,
        ...
        - *when-idle* holds the ring — `ring_deferred` — and `flush_pending` rings it once
          ...
          when-idle by their nature (DESIGN-TRUTH.md:381-385 for `done`).
    ...
    def reconcile(self, *, snap=None) -> list[str]:
        ...
        **The ping goes to the agent, never to its parent** (`DESIGN-TRUTH.md:155-159`):
