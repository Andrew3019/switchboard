...
# `sb tell`'s three delivery modes (DESIGN-TRUTH.md:367-378). They differ only in WHEN the
...
class Broker:
    ...
    def same_tree(self, me: str, target: str) -> bool:
        ...
        The human crosses freely into any tree — DESIGN-TRUTH:304-305, "Only agents have
    ...
    def tell(
        ...
        no agent ever waits on another agent (DESIGN-TRUTH.md:363-365), which is why this
    ...
    def apply_preset(self, name: str, *, me: Optional[str] = None) -> int:
        ...
        DESIGN-TRUTH.md:428-431: "Picking a preset should inject a prompt: sb pastes it in,
    ...
    def done(self, summary: str, *, me: Optional[str] = None) -> list[str]:
        ...
        **Reporting done with children still working stays legal**, and the returned list
        ...
        if parent:
            ...
            #
            # WHEN IDLE, explicitly and not by default — DESIGN-TRUTH.md:349-353 names the
    ...
    def _ring(self, who: str, text: str, *, mode: str = WHEN_IDLE,
        ...
        - *when-idle* holds the ring — `ring_deferred` — and `flush_pending` rings it once
          ...
          when-idle by their nature (DESIGN-TRUTH.md:349-353 for `done`).
