> **⚠️ SUPERSEDED — this is the FALLBACK plan, not the recommendation.**
> The primary recommendation for running switchboard on a Windows PC is **WSL2** — see
> [`../windows-support-plan.md`](../windows-support-plan.md). This native-port plan is retained
> as the "if you ever want fully-native Windows (no Linux layer)" option. It is a large,
> unbuilt engineering effort sitting on herdr's *experimental-beta* Windows support, and should
